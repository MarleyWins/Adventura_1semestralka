...
public class HerniPlan implements SubjektZmenyProstoru{
    ...
    private void zalozProstoryHry() {
        ...
        Prostor victory = new Prostor ("Crossroads","You have reached the end of your brief jurney. You have learned so much", 50.00, 50.00);        
    ...
    public void zaregistrujPozorovatele(ObserverZmenyProstoru pozorovatel) {
        observerListProstor.add(pozorovatel);
    }

    @Override
    public void odregistrujPozorovatele(ObserverZmenyProstoru pozorovatel) {
        observerListProstor.remove(pozorovatel);
    }

    @Override
    public void notifyObservers() {
        for (ObserverZmenyProstoru observer : observerListProstor) {
            observer.refresh();
        }
    }
}
