...
class CommandEnd implements IPrikaz {
    ...
    public String provedPrikaz(String... parametry) {
        if (parametry.length > 0) {
            return "I have to end what? If you wish to quit just type end";
        }
        else {
            hra.setKonecHry(true);
            return "Game was ended by command end";
        }
    }
